...
/**
 * Equivalent for EmptyCoroutineContext in [DependentCoroutineContext]
 */
object EmptyDependentCoroutineContext : DependentCoroutineContext {
    ...
    override fun plus(context: DependentCoroutineContext): DependentCoroutineContext {
        return context
    }
